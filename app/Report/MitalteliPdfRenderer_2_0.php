 ...
 * Class PdfRenderer
 */
class MitalteliPdfRenderer_2_0 extends PdfRenderer
{
    ...
    {
        $this_reflection_class = new \ReflectionClass('\vendor\WebtreesModules\mitalteli\ResearchTasksReportNamespace\Report\MitalteliPdfRenderer_2_0');
